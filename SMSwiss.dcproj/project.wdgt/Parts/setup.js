...
var dashcodePartSpecs = {
    ...
    "phoneBookLabel": { "creationFunction": "CreateText", "text": "This option enable you to filter the result of the phone book search. It only shows the phone numbers of the specified type." },
